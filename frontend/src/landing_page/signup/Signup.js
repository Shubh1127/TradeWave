        ...
        <div className=' container'>
            <div className='row '>
                ...
                <div className='col-4  m-5 '>
                    ...
                    <form className=" border border-3 rounded p-5 d-flex flex-column" style={{width:"23rem"}} >
                    <label htmlFor="email" className="text-start ps-2">Email</label>
                    <input className="m-2 p-1 rounded" type="email" id="email" placeholder="Email"  ></input>
                    <label htmlFor="username" className="text-start ps-2">Username</label>
                    <input className="m-2 p-1 rounded " type="text" placeholder="username" id="username" ></input>
                    <label htmlFor="password" className="text-start ps-2">Password</label>
                    <input className="m-2 p-1 rounded " type="password" placeholder="Enter password" id="password"></input>
